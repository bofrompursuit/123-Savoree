export default function ParrotIcon({ className }: { className?: string }) {
  return (
    ...
    >
      {/* tail */}
      <path d="M50 60 C 66 66, 74 78, 70 92 C 60 84, 52 76, 48 64 Z" fill="#2ecc71" />
      <path d="M50 60 C 60 70, 64 82, 58 94 C 50 86, 46 76, 46 64 Z" fill="#10b981" />

      {/* body */}
      <ellipse cx="46" cy="52" rx="24" ry="26" fill="#2ecc71" />
