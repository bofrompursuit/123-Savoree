export default function Hero() {
  return (
    ...
    >
      <div className="pointer-events-none absolute -left-16 -top-16 h-64 w-64 rounded-full bg-savoree-green-bright/15 blur-3xl" />
      ...
      <div className="relative mx-auto flex max-w-4xl flex-col items-center text-center">
        <span className="mb-5 inline-flex items-center gap-2 rounded-full bg-white px-4 py-1.5 text-sm font-bold text-savoree-green-dark shadow-sm">
        ...
        <h1 className="font-display text-4xl font-semibold leading-[1.05] tracking-tight text-savoree-ink sm:text-6xl">
          ...
          <br />
          come in{" "}
          <span className="relative inline-block text-savoree-green">
            3&apos;s
          </span>
          .
        </h1>
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <a
            href="#recipes"
            className="rounded-full bg-savoree-lime px-8 py-3.5 text-base font-bold text-savoree-ink shadow-lg shadow-savoree-lime/30 transition hover:-translate-y-0.5 hover:bg-savoree-lime-dark"
          >
            Start Cooking
          </a>
          <a
